...
export const eventScheduleData: EventScheduleItem[] = [
  { day: 'Tuesday', start_time: '08:45', end_time: '10:10', event: 'Presentation: Introduction & Planning', location: 'Pitch Room' },
  ...
  { day: 'Wednesday', start_time: '08:45', end_time: '12:40', event: 'Interviews & Box Lunch', location: 'off-site' },
  { day: 'Wednesday', start_time: '13:45', end_time: '14:15', event: 'Team Presentations: Problem Identification', location: 'on-site' },
  { day: 'Wednesday', start_time: '14:15', end_time: '14:45', event: 'Presentation: Developing Solutions', location: 'Pitch Room' },
  { day: 'Wednesday', start_time: '14:45', end_time: '15:30', event: 'Team Work', location: 'on-site' },
  { day: 'Thursday', start_time: '08:45', end_time: '09:10', event: 'Presentation: Solution Ideation & Prototyping', location: 'on-site' },
  ...
  { day: 'Thursday', start_time: '12:00', end_time: '12:45', event: 'Presentation: Assessing Pitches', location: 'Pitch Room' },
  ...
  { day: 'Friday', start_time: '08:45', end_time: '09:10', event: 'Presentation: Pitch Development', location: 'Pitch Room' },
